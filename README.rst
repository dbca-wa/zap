...
A Django 1.9 app template for Dept Parks & Wildlife WA
...
.. code-block:: bash
    ...
    cd zap
    celery -A zap.taskapp worker -l info
...
To run the tests, enter the zap/tests directory and run the following commands::
